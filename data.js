const projects = [
    ...
    title: "KAINO",
    italicWord: "Agent",
    tags: ["AI Agent", "Rhino SDK", "C#", "Conversational Design"],
    desc: "Conversational AI design assistant for Rhino, developed with the KPFui team to let designers query and control models through natural language.",
    highlight: "KAINO embeds a conversational AI agent directly into Rhino, letting designers ask questions, run commands, and iterate on models through natural language instead of manual scripting.",
    long: "KAINO is an AI agent built for Rhino that translates natural language into design actions, allowing designers to query model state, trigger operations, and iterate on geometry through conversation. Developed with the KPFui team, it aims to lower the barrier between design intent and execution inside the Rhino environment.",
    year: "2026",
    medium: "Software / AI Agent",
    image: "Image/Project_13/01_DH_Proj13.png",
    ...
    images: [
      ...
      //   layout: "single"
      // },
      // { src: "Image/Project_11/03_DH_Proj11.png", 
      //   // title: "Rhythm Mechanics",
      //   // text: "The game introduces an interactive system built using p5.js and a microcontroller to translate rhythmic inputs into real-time carbonation pressure.",   
      //   reverse: true,
      //   layout: "single"
    ...
    id: "02",
    title: "GH Modifier",
    italicWord: "Dashboard",
    tags: ["Grasshopper Plugin", "C#", "AI Agent", "KPFui"],
    desc: "Grasshopper extension of KAINO that adds a parameter-control dashboard, giving designers a direct interface to interact with the AI agent inside Grasshopper.",
    highlight: "GH Modifier extends KAINO into Grasshopper as a dashboard for parameter control, letting designers steer the AI agent's outputs directly within their parametric workflow.",
    long: "GH Modifier is a Grasshopper extension of KAINO that surfaces a parameter-control dashboard inside the canvas, enabling designers to configure inputs and interact with the AI agent without leaving their Grasshopper workflow. Developed with the KPFui team, it bridges conversational AI control with the parametric design environment.",
    year: "2026",
    medium: "Software / Plugin",
    image: "Image/Project_15/01_DH_Proj15.png",
    // video: "https://www.youtube.com/embed/3DzUXXrBslM?autoplay=1&mute=1",
    location: "New York, NY",
    status: "Completed",
    color: "linear-gradient(135deg, #3d4e1f 0%, #2c3816 100%)",
    ...
    highlight: "A fast-paced rhythm battle where players race to build maximum pressure in a soda bottle through tapping and shaking. The first bottle to pop determines the winner in an explosive showdown.",
    ...
    images: [
      ...
      // {
      //   layout: "single",
      //   src: "Image/Project_10/05_DH_Proj10_2.gif", 
      //   title: "Tap on Rythm",
      //   // text: "Dayak cosmology unites land, spirits, and humans within interconnected cosmic realms. The sacred meranti tree links physical and ancestral worlds and is used only for essential needs. Through ritual sacrifice and liver divination, territorial decisions align with cosmic balance, making forest defense both political resistance and sacred obligation.",
      // },
      // {
      //   layout: "single",
      //   src: "Image/Project_10/05_DH_Proj10_3.gif",
      //   title: "Shake to Build Pressure",
      //   // text: "Dayak cosmology unites land, spirits, and humans within interconnected cosmic realms. The sacred meranti tree links physical and ancestral worlds and is used only for essential needs. Through ritual sacrifice and liver divination, territorial decisions align with cosmic balance, making forest defense both political resistance and sacred obligation.",
      // },
      //       {
      //   layout: "single",
      //   src: "Image/Project_10/05_DH_Proj10_4.gif", 
      //   title: "Twist to Reveal the Winner",
      //   // text: "Dayak cosmology unites land, spirits, and humans within interconnected cosmic realms. The sacred meranti tree links physical and ancestral worlds and is used only for essential needs. Through ritual sacrifice and liver divination, territorial decisions align with cosmic balance, making forest defense both political resistance and sacred obligation.",
      // },
  ...
  },
  {
    ...
    title: "Room Beats",
    italicWord: "Beats",
    tags: ["Sound Design", "AI", "Product Design", "Music"],
    desc: "A musical AI instrument that samples sounds from everyday objects and recomposes them into original instrument compositions.",
    highlight: "Room Beats turns everyday objects into a musical instrument, sampling their sounds and using AI to recompose them into original compositions.",
    long: "Room Beats is a musical AI instrument that samples sounds captured from everyday objects and recomposes them into original instrument compositions, turning ordinary surroundings into a playable, generative sound palette.",
    year: "2026",
    medium: "Sound Design / AI Instrument",
    image: "Image/Project_12/01_DH_Proj12.png",
    // video: "https://www.youtube.com/embed/3DzUXXrBslM?autoplay=1&mute=1",
    location: "Cambridge, MA",
    status: "Ongoing",
    color: "linear-gradient(135deg, #3d4e1f 0%, #2c3816 100%)",
    images: [
      // { src: "Image/Project_12/05_DH_Proj12.png", 
      //   // title: "Rhythm Mechanics",
      //   // text: "The game introduces an interactive system built using p5.js and a microcontroller to translate rhythmic inputs into real-time carbonation pressure.",   
      //   reverse: false,
      //   layout: "single"
      // },
      // { src: "Image/Project_12/02_DH_Proj12.png", 
      //   // title: "Rhythm Mechanics",
      //   // text: "The game introduces an interactive system built using p5.js and a microcontroller to translate rhythmic inputs into real-time carbonation pressure.",   
      //   reverse: true,
      //   layout: "single"
      ...
      // {
      //   layout: "full",
      //   src: "Image/Project_12/03_DH_Proj12.png", 
      //   // title: "Illicit Process During Extraction",
      //   // text: "Extraction in West Borneo brings social and material devastation beyond forest loss. Dayak families face eviction, burned homes, destroyed tools, and illegal logging practices that evade detection. As exploitation deepens, communities turn to prayer and ritual, drawing spiritual resilience to endure and resist forces greater than their political and economic power.",
      // },
      // { src: "Image/Project_12/04_DH_Proj12.png", 
      //   // title: "Rhythm Mechanics",
      //   // text: "The game introduces an interactive system built using p5.js and a microcontroller to translate rhythmic inputs into real-time carbonation pressure.",   
      //   reverse: false,
      //   layout: "single"
  ...
  },
  {
    ...
    italicWord: "Machine",
    tags: ["Research", "Institutional History", "Singapore", "Industrial Policy"],
    desc: "Research project examining the establishment of Singapore's Jurong Town Corporation (JTC) and its role in shaping the nation's industrial infrastructure.",
    highlight: "The Institutional Machine traces the founding of Singapore's Jurong Town Corporation (JTC), examining how a single state institution engineered the country's rapid industrialization and reshaped its urban and economic landscape.",
    long: "The Institutional Machine examines the establishment of Singapore's Jurong Town Corporation (JTC), the statutory board created to spearhead the nation's industrial development. The research traces how JTC's formation consolidated land acquisition, infrastructure provision, and industrial estate planning under a single institutional apparatus, enabling Singapore's rapid industrialization in the decades following independence. By tracing this institutional machinery, the project examines the relationship between state power, land, and urban form in shaping Singapore's development trajectory.",
    year: "2026",
    medium: "Drawing / Research",
    image: "Image/Project_16/01_DH_Proj16.png",
  ...
  },
  {
    ...
    highlight: "Global demand for meranti is accelerating deforestation and land conflicts in Sabar Bubu, West Borneo, where state forestry concessions increasingly overlap with Indigenous Dayak territories. As a vital ecological, cultural, and spiritual resource, the loss of meranti threatens not only the forest but also the identity and sovereignty of the communities that depend on it.",
    ...
    video: "https://www.youtube.com/embed/kDRsn2oVqQE?autoplay=1&mute=1",
    location: "West Borneo, Indonesia",
    status: "Completed",
    color: "linear-gradient(135deg, #3d4e1f 0%, #2c3816 100%)",
    images: [
      { src: "Image/Project_1/01_DH_Proj1.png", 
  ...
  },
  {
    ...
    title: "Common Ground",
    italicWord: "Ground",
    tags: ["ULI Student Competition", "Urban Design","Master Plan","Computational Design"],
    desc: "Urban Land Institute (ULI) Americas Student Competition finalist proposal rejuvenating a commercial masterplan in Austin, Texas.",
    highlight: "Common Ground reimagines an underperforming commercial site in Austin as a mixed-use, community-oriented masterplan, advancing as a finalist proposal in the 2026 ULI Americas Student Competition.",
    long: "Common Ground is a finalist proposal in the 2026 Urban Land Institute (ULI) Americas Student Competition, rejuvenating an aging commercial site in Austin, Texas into a mixed-use masterplan. The proposal reimagines underutilized retail land as a walkable, community-oriented district, balancing market viability with public space, connectivity, and long-term resilience.",
    year: "2026",
    medium: "Finalist Proposal",
    ...
    },
  {
    ...
    highlight: "Reimagining South Bronx streets as people-first public spaces, this proposal reallocates excess roadway space to improve pedestrian safety, expand community use, and support more equitable mobility.",
    ...
    prototype: {
      url: "https://sbx-atlas-map.vercel.app/",
      label: "Map Platform"  
    },
  ...
  },
  {
    ...
    highlight: "OrangoPlan is a parametric urban design toolkit that streamlines the creation, analysis, and visualization of complex planning workflows. It empowers designers to rapidly generate and evaluate adaptive street networks, land-use scenarios, building massing, public spaces, and infrastructure systems.",
    ...
    prototype: {
      url: "https://danieljharianto.github.io/OrangoplanDocs/",
  ...
  },
  {
    ...
    highlight: "Rooted in the cultural legacy of Semarang’s fishing communities, the proposal preserves heritage architecture while strengthening resilience against environmental degradation and social marginalization.",
  ...
  {
    id: "11",
    title: "Nusantara Urban Design Guidelines",
    ...
    highlight: "The Government Core (KIPP) master plan for Indonesia’s new capital establishes a future-ready urban framework that integrates governance, education, and wellness through data-driven planning and archipelago-inspired design.",
    ...
    prototype: {
      url: "https://www.youtube.com/watch?v=8WiPsEliVn8",
      label: "Press Release"  
    },
  ...
  },
  {
    ...
    tags: ["Research", "C#", "Python", "Urban Mobility", "KIAT"],
    desc: "TOD-POD implementation template developed in collaboration with KIAT (Indonesia Australia Partnership for Infrastructure) to shape urban mobility in the Jakarta Metropolitan Area.",
    highlight: "Developed in collaboration with KIAT (Indonesia Australia Partnership for Infrastructure), the project addresses the implementation gap in urban planning, promoting Transit-Oriented Development and walkable urban environments as key frameworks for Jakarta’s future growth.",
    long: "Developed in collaboration with KIAT (Indonesia Australia Partnership for Infrastructure), this project addresses the Jakarta metropolitan area (Jabodetabek), which consists of Jakarta, Bogor, Depok, Tangerang, and Bekasi, covering over 6,438 sq km, and is considered the second largest metropolitan area in the world after the Tokyo metropolitan area in Japan (14,034 sq km). The metropolitan area is home to a population of 40 million people in 2022. There has been relatively little focus on the ‘implementation’ of strategic imperatives, with most urban development and transit initiatives emerging through either reactive or speculative means. Therefore, the city’s planning administration needs to strengthen its understanding and knowledge in planning Transit-Oriented Development (TOD) and Pedestrian-Oriented Design (POD).",
    year: "2023",
    medium: "Computational Design",
  ...
  
  {
    ...
    desc: "Repurposing salvaged construction materials into resilient, affordable housing for a Central Java coastal community facing land subsidence and tidal flooding.",
    highlight:"The project reimagines material waste as an asset for climate adaptation, supporting resilient housing and sustainable livelihoods in one of Indonesia’s most vulnerable coastal communities.",
  ...
  {
    id: "14",
    title: "North South Corridor - NSC",
    italicWord: "Corridor",
    tags: ["Competition", "Urban Design", "Infrastructure", "Computational Design"],
    desc: "Winning proposal for Singapore's North South Corridor, developed with Henning Larsen as the lead design team for Singapore's Land Transport Authority (LTA).",
    highlight: "Working alongside Henning Larsen as the winning team, the project reimagines the North South Corridor as an integrated transit and public realm spine for Singapore, developed for Singapore's Land Transport Authority (LTA).",
    long: "Developed for Singapore's Land Transport Authority (LTA) in collaboration with Henning Larsen as the winning design team, North South Corridor (NSC) establishes an integrated framework for one of Singapore's key transit and urban corridors. Custom computational workflows organized spatial, infrastructure, and urban design inputs into a flexible decision-making process, enabling rapid testing of alignments, public realm configurations, and development scenarios along the corridor.",
    year: "2024",
    medium: "GIS Analysis and Computational Design",
    image: "Image/Project_14/01_DH_Proj14.png",
        prototype: {
      url: "  https://www.youtube.com/watch?v=Er7n4QQMIcw",
      label: "Press Released"  
    },
    location: "Singapore",
    status: "On Progress",
  ...
  {
    id: "15",
    title: "Jakarta TOD Gentle Density",
    italicWord: "Gentle Density",
    tags: ["Research", "C#","Java Script","Python"],
    desc: "Parametric housing model exploring gentle density and missing-middle typologies around Jakarta's Tanah Abang transit-oriented development.",
    highlight: "Using parametric design tools, the project generates housing solutions that balance affordability, density, and transit accessibility in the rapidly growing Jakarta metropolitan region.", 
  ...
  {
    id: "16",
    title: "Turquoise - Middle East Strategic",
    italicWord: "Strategic",
    tags: ["Research", "C#", "Python", "Planning Modelling"],
    desc: "Integrating spatial data, modeling, and scenario testing to guide design and market decisions",
    highlight: "The project leveraged custom computational workflows to optimize parcel configurations, infrastructure alignments, and waterfront frontage, creating resilient and market-responsive urban development strategies.",
    ...
    year: "2023",
    medium: "Computational Design",
    image: "Image/Project_9/11_DH_Proj9.png",
  ...
  {
    id: "17",
    title: "Ramhan Island Masterplan",
    italicWord: "Strategic",
    tags: ["Research", "C#", "Python", "Planning Modelling"],
    desc: "Integrating spatial data, modeling, and scenario testing to guide design and market decisions",
    highlight: "The project leveraged custom computational workflows to optimize parcel configurations, infrastructure alignments, and waterfront frontage, creating resilient and market-responsive urban development strategies.",
  ...
  },
  {
    ...
    year: "2023",
    medium: "Computational Design",
    image: "Image/Project_9/12_DH_Proj9.png",
    location: "Abu Dhabi, UAE",
    status: "On Progress",
    color: "linear-gradient(160deg, #3d4e1f 0%, #5a7225 100%)",
    images: [
